 ...
 * @author felipe araujo <felipe.s-04@hotmail.com>
 */
...
public class SaveImageGallery extends CordovaPlugin {
  ...
  private final String READ_MEDIA_VISUAL_USER_SELECTED = Manifest.permission.READ_MEDIA_VISUAL_USER_SELECTED;
    ...
    if (action.equals(REMOVE_IMAGE_ACTION)) {
      ...
      if (PermissionHelper.hasPermission(this, WRITE_EXTERNAL_STORAGE)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
          PermissionHelper.requestPermissions(this, WRITE_PERM_REQUEST_CODE,
              new String[] { READ_MEDIA_IMAGES, READ_MEDIA_VISUAL_USER_SELECTED });
        } else if (Build.VERSION.SDK_INT == Build.VERSION_CODES.TIRAMISU) {
          PermissionHelper.requestPermissions(this, WRITE_PERM_REQUEST_CODE, new String[] { READ_MEDIA_IMAGES });
        } else {
          PermissionHelper.requestPermissions(this, WRITE_PERM_REQUEST_CODE, new String[] { WRITE_EXTERNAL_STORAGE });
        }
      }
    }
  ...
  /**
   * Private method to save a {@link Bitmap} into the photo library/temp folder
   * with a format, a prefix and with the given quality.
   */
